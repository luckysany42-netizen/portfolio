...
**Website Link:** [https://www.ukiyy.my.id/](https://www.ukiyy.my.id/)
...
This project is built using modern web technologies:
  ...
  - **Supabase** - Backend for portofolio data, certificates, and comment system
...
-- Creates the 'projects' table for portofolio items
